      ...
      <section className="w-1/6 h-screen flex flex-col p-6">
        ...
        <section className="flex  basis-1/12 justify-between items-center">
          <div className="flex">
              ...
              <h2 className="text-white self-end justify-items-end ml-3 text-lg ">StudyBuddy</h2>
          </div>
        </section>

        <section className="flex flex-col p-4 relative items-center h-1/4  basis-2/5">
              <img src="" alt="ProfilePicture" className="h-24 w-24 rounded-full " />
              <div className="h-5 w-16 rounded-full bg-white justify-center align-center flex absolute top-24   text-black ">details</div>
              <h3 className="text-lg pt-7">soteria</h3>
              <p className=" text-gray-400 pt-3">soterialawrence009@gmail.com</p>
        </section>

        <section className="flex flex-col p-4 grow justify-around items-center">
